defmodule TransporterWeb.ImageControllerTest do
  use TransporterWeb.ConnCase

  alias Transporter.Logistic

  @create_attrs %{activity_id: 42, filename: "some filename", thumbnail: "some thumbnail"}
  ...
  def fixture(:image) do
    {:ok, image} = Logistic.create_image(@create_attrs)
    image
  end
