defmodule TransporterWeb.UserControllerTest do
  use TransporterWeb.ConnCase

  alias Transporter.Settings

  @create_attrs %{crypted_password: "some crypted_password", email: "some email", password: "some password", pin: "some pin", user_level: "some user_level", user_type: "some user_type", username: "some username"}
